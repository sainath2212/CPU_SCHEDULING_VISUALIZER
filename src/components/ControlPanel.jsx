...
export default function ControlPanel({
    ...
    return (
        <div className="control-panel">
            ...
            <div className="control-section gap-2 flex items-center">
                {!isRunning ? (
                    <MagicButton className="rounded-full" innerClassName="px-4 py-2 flex items-center gap-2" title="Play / Resume" onClick={onStart} disabled={disabled || isCompleted}>
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><polygon points="5 3 19 12 5 21 5 3" /></svg>

                    </MagicButton>
                ) : (
                    <MagicButton className="rounded-full" innerClassName="px-4 py-2 flex items-center gap-2" title="Pause" onClick={onPause}>
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><rect x="6" y="4" width="4" height="16" /><rect x="14" y="4" width="4" height="16" /></svg>

                    </MagicButton>
                )}

                <MagicButton className="rounded-full" innerClassName="px-4 py-2 flex items-center gap-2" title="Step Forward" onClick={onStep} disabled={disabled || isCompleted || isRunning}>
                ...
                <MagicButton className="rounded-full" innerClassName="px-4 py-2 flex items-center gap-2" title="Run to End" onClick={onRunToEnd} disabled={disabled || isCompleted || isRunning}>
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
            ...
            <div className="control-section">
                <MagicButton onClick={onReset} disabled={disabled}>
