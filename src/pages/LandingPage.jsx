  ...
  return (
    <div className="landing-spline-wrapper">
      ...
      <iframe
        ...
        src="https://my.spline.design/boxeshover-vSIc9iqinwdDAhRhl07cbDBJ/"
        frameBorder="0"
        width="100%"
        height="100%"
      />

      {/* ═══ SPLINE HERO (first viewport) ═══ */}
      <div className="landing-spline-fullpage">

        <nav className="spline-nav">
          <motion.div
            className="spline-nav-brand"
        ...
        <div className="spline-hero-center">
          <motion.div
          ...
          >
            CPU Scheduling<br />Visualizer
          </motion.h1>

          <motion.p
            className="spline-hero-desc"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 0.6 }}
          >
            Simulate, visualize, and compare OS scheduling algorithms in real time
            with AI-powered recommendations and interactive analytics.
          </motion.p>

          <motion.div
            className="spline-hero-buttons"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
      ...
      {/* ═══ BELOW-FOLD CONTENT ═══ */}
      <div className="landing-content-below">
        {/* Demo Gantt */}
        <section className="landing-demo-section" style={{ position: 'relative' }}>
          ...
          <motion.div
            ...
            style={{ perspective: '800px', maxWidth: '700px', margin: '0 auto', position: 'relative', zIndex: 2 }}
          >
                ...
                <div className="demo-gantt">
                  {demoBlocks.map((b, i) => (
                    <motion.div
                      ...
                      whileInView={{ opacity: 1, scaleX: 1, rotateY: 0 }}
                      viewport={{ once: true }}
